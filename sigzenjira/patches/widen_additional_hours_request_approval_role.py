...
def execute():
	# create_additional_hours_request_workflow (setup.py) only inserts the
	...
	# now (Project User.custom_project_user_approve_extra_hours), so this role is
	# intentionally broad - see the comment in setup.py.
